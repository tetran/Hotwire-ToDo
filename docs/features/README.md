...
| 操作 | 備考 |
|------|------|
| 一覧 | Provider Workspace 内に統合表示（名称・表示名・有効状態・使用数） |
| 作成 (`/admin/llm-providers/:id/models/new`) | name・display_name・active |
| 編集 (`/admin/llm-providers/:id/models/:modelId/edit`) | display_name・active（name は変更不可） |
