module Authorization
  ...
  private
    ...
    def authorize_resource!(resource_type, action)
      return if current_user&.has_permission?(resource_type, action.to_s)
