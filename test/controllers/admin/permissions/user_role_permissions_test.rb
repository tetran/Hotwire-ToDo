...
class Admin::UserRolePermissionsIntegrationTest < ActionDispatch::IntegrationTest
  setup do
    ...
    admin_read_perm = Permission.find_or_create_by!(resource_type: 'Admin', action: 'read') { |p| p.description = 'Admin read' }
    user_read_perm = Permission.find_or_create_by!(resource_type: 'User', action: 'read') { |p| p.description = 'User read' }
    user_write_perm = Permission.find_or_create_by!(resource_type: 'User', action: 'write') { |p| p.description = 'User write' }
