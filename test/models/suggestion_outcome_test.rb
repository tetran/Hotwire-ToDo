...
class SuggestionOutcomeTest < ActiveSupport::TestCase
  ...
  test "should require total_suggested" do
    ...
    assert_includes outcome.errors[:total_suggested], "is not a number"
  end
  ...
  test "should require total_adopted" do
    ...
    assert_not outcome.valid?
    assert_includes outcome.errors[:total_adopted], "is not a number"
  end
  ...
  test "should reject negative total_suggested" do
    ...
    assert_not outcome.valid?
    assert_includes outcome.errors[:total_suggested], "must be greater than or equal to 0"
  end
  ...
  test "should reject negative total_adopted" do
    ...
    assert_not outcome.valid?
    assert_includes outcome.errors[:total_adopted], "must be greater than or equal to 0"
  end
